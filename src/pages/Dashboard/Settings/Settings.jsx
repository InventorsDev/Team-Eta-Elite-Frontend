        ...
        <div id="settingsPage">
            ...
            <div className="mt-10   border-1 border-[#0000001A] p-7 rounded-lg shadow-md">
                ...
                <div className="mt-10">
                    ...
                    {showConfirm && (
                        <div className="fixed z-1000 w-full overflow-hidden inset-0 flex items-center justify-center backdrop-blur-sm  bg-[var(--primary-color)]/10">
                            <div className="border-1 bg-white border-gray-200 py-10 px-8 rounded-[10px]  shadow-gray-400 shadow-lg w-[90%] md:w-[500px]">
                                <div className="font-semibold flex flex-col justify-center items-center text-center  mb-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="Red" className="size-15">
